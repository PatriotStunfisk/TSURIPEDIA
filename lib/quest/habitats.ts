...
export const questHabitats:QuestHabitat[]=[
 {slug:'cold-lake',name:'冷水湖・沖',description:'ヒメマスの群れの棚とビワマスの走りを体験。実釣の承認・解禁期間・仕掛けは湖ごとに確認。',methods:['lake-trolling','himemasu-sabiki','trout-lure'],mapQuery:'湖',fightDepth:25},
 {slug:'warm-ocean',name:'暖海・外洋',description:'GTの突進、キハダの長い走り、カジキのジャンプ。実釣は専門船の安全指示と地域規則を優先。',methods:['offshore-casting','marlin-trolling','jigging','nomase'],mapQuery:'船',fightDepth:25},
 {slug:'lake-pier',name:'湖の桟橋',description:'ワカサギの小さなアタリ、バスの追尾、ウキの沈みを見分ける。実釣は施設規則・外来魚の扱いを確認。',methods:['wakasagi','bass-lure','freshwater-float','namazu-topwater'],mapQuery:'ワカサギ',fightDepth:8},
 ...
 {slug:'northern-coast',name:'北の沿岸',description:'チカやニシンの群れ、カレイの底の重み、根魚の突進を釣り分ける。実際の釣り場と利用規則はMAPで確認。',methods:['rockfish-lure','douzuki','sabiki','uki','nage','choinage','casting','tako-egi'],mapQuery:'北海道',fightDepth:12},
