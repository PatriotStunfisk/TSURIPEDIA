...
export const questHabitats:QuestHabitat[]=[
 ...
 {slug:'wakayama',name:'和歌山・沿岸',description:'エギングから船釣りまで、幅広い組み合わせを試す。',methods:['eging','tiprun','sabiki','kawahagi','jigging','boat-kisu','casting','fukase','otoshikomi','isaki-komase'],mapQuery:'和歌山'},
