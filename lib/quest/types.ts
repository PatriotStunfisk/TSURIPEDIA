import type {HookAttachment} from './hook-anchor';
export type FightProfile='balanced'|'runner'|'diver'|'jumper'|'bottom'|'jet';
export type QuestParameters={
 hook?:HookAttachment;enabled?:boolean;rarity?:number;fightPower?:number;biteRate?:number;escapeRate?:number;xp?:number;
 habitats?:string[];methods?:string[];sizeRange?:[number,number];
 fightProfile?:FightProfile;swimSpeed?:number;wariness?:number;approachSpeed?:number;biteWindowMs?:number;stamina?:number;runPower?:number;
};
export type QuestFish={
 ...
 hook?:HookAttachment;image?:string;modelSrc?:string;modelTilt?:number;cooking:boolean;guideHref?:string;
 sizeUnit?:'cm'|'kg';fightProfile?:FightProfile;swimSpeed?:number;wariness?:number;approachSpeed?:number;biteWindowMs?:number;stamina?:number;runPower?:number;
};
...
export type QuestHabitat={fightDepth?:number;slug:string;name:string;description:string;methods:string[];mapQuery:string};
