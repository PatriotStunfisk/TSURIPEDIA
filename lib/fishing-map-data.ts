...
export const fishingMapEntries:FishingMapEntry[]=[
  {
    slug:'mukogawa-ichimonji',type:'spot',name:'武庫川一文字',area:'兵庫・大阪湾',lat:34.699,lng:135.353,
  ...
  {
    slug:'hira-isoumi',type:'spot',name:'平磯海づり公園',area:'兵庫・神戸',lat:34.6255,lng:135.0679,
  ...
  {
    slug:'tottopark-kojima',type:'spot',name:'とっとパーク小島',area:'大阪・岬町',lat:34.3064,lng:135.0967,
  ...
  {
    slug:'nanko-fishing-park',type:'spot',name:'大阪南港魚つり園護岸',area:'大阪・南港',lat:34.6156,lng:135.4019,
    fish:['アジ','サバ','タチウオ','青物'],methods:['サビキ','ショアジギング','タチウオ'],season:'春〜冬',beginner:true,kids:true,parking:false,toilet:false,
  ...
  {
    slug:'kada-port',type:'spot',name:'加太港',area:'和歌山・加太',lat:34.2756,lng:135.0714,
