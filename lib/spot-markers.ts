...
export function markerKind(e:Pick<FishingMapEntry,'type'|'terrain'>):keyof typeof markerKinds{
 ...
 switch(e.terrain){case 'boat':return 'area';case 'park':case 'sea-pond':return 'park';case 'pier':case 'port':return 'pier';case 'beach':return 'beach';case 'rock':return 'rock';case 'estuary':return 'estuary';case 'river':case 'lake':case 'pond':return 'fresh';default:return 'shore';}
}
...
export function clusterCellSize(zoom:number){return zoom<7?40:zoom<9?30:zoom<11?22:12;}
