...
export const markerKinds={
 boat:{label:'釣船・船宿',symbol:'船',color:'#793eb5'},facility:{label:'海釣り施設',symbol:'釣',color:'#147348'},port:{label:'港',symbol:'港',color:'#567b8b'},park:{label:'公園',symbol:'公',color:'#147348'},pier:{label:'堤防',symbol:'堤',color:'#1765a6'},beach:{label:'サーフ',symbol:'浜',color:'#9b650b'},rock:{label:'磯',symbol:'磯',color:'#665245'},estuary:{label:'河口',symbol:'河',color:'#157f86'},fresh:{label:'湖・川・管理池',symbol:'淡',color:'#417537'},area:{label:'釣行計画エリア',symbol:'域',color:'#627083'},shore:{label:'海岸・その他',symbol:'岸',color:'#3d7189'},
} as const;
