import {species168Methods} from './method-details-species-168';
...
export const methodDetails={...species168Methods,...kansaiGrowthMethods,...pondMethods,...largeFishMethods,...ayuingMethods,...freshwaterMethods,...baseMethodDetails,...extraMethodDetails,...extraMethodDetails2,...batchMethodDetails,...coastalMethodDetails,...nextMethodDetails,...nationalMethodDetails};
