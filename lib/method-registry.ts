...
export const methodDetails={...pondMethods,...largeFishMethods,...ayuingMethods,...freshwaterMethods,...baseMethodDetails,...extraMethodDetails,...extraMethodDetails2,...batchMethodDetails,...coastalMethodDetails,...nextMethodDetails,...nationalMethodDetails};
