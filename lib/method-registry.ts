...
export const methodDetails={...freshwaterMethods,...baseMethodDetails,...extraMethodDetails,...extraMethodDetails2,...batchMethodDetails,...coastalMethodDetails,...nextMethodDetails,...nationalMethodDetails};
