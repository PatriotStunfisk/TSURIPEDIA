...
const calibratedModels=new Set(['suzuki','kurodai','maiwashi','kanpachi','isaki','anago','ayu','magochi','akahata','houbou','itoyoridai','kijihata','kouika','mahaze','mejina','hirame'].map(slug=>`/models/${slug}.glb`));
