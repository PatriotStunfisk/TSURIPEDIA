...
export async function catchFeed(filters:{fish?:string;method?:string;spots?:string[];from?:string;to?:string;minSize?:number;maxSize?:number},offset=0){
 ...
 if(filters.minSize!==undefined)query.append('size_cm','gte.'+filters.minSize);
 if(filters.maxSize!==undefined)query.append('size_cm','lte.'+filters.maxSize);
