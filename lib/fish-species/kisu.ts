...
export default defineFishSpecies({
  fieldNotes: [{"heading": "釣れた距離へ戻す", "body": "砂地を広く探るときは方向と距離を同時に変えず、まず同じ距離で左右を比較します。アタリが出るまでの巻き数を覚えると、次の投入でも群れのいる範囲を通しやすくなります。"}, {"heading": "アタリの後は餌も観察", "body": "強い振動があって掛からなかったら、餌の先端だけが傷んでいるか確認します。先だけ食われる場合は垂らしを短くする余地があります。同じ場所で毎回一度だけ重くなるなら、魚ではなく底の変化の可能性も考えます。"}],
  ecologyVisual:{
  ...
  cooking:{
    prepImages: [{"step":2,"src":"/images/preparation/kisu-butterfly.webp","alt":"シロギスを開き、中骨を外して尾を残した状態"}],
  ...
  {
    "step": 1,
    "src": "/images/cooking/steps/kisu-tempura-1.svg",
    "alt": "シロギスの天ぷら：開いて中骨を外す",
    "caption": "開いたキスは腹骨と中骨の取り残しを確認。身を洗ったら水気を十分に拭きます。"
  },
  {
    "step": 2,
    "src": "/images/cooking/steps/kisu-tempura-2.svg",
    "alt": "シロギスの天ぷら：冷たい衣を薄く",
    "caption": "衣を厚く付けるとキスの薄い身とのバランスが悪くなります。余分な衣を軽く切ります。"
  },
  {
    "step": 3,
    "src": "/images/cooking/steps/kisu-tempura-3.svg",
    "alt": "シロギスの天ぷら：油へそっと広げる",
    "caption": "身が折れ重ならないように入れます。泡や色だけで決めず、中心まで火を通します。"
  },
  {
    "step": 4,
    "src": "/images/cooking/steps/kisu-tempura-4.svg",
    "alt": "シロギスの天ぷら：揚げたてを重ねない",
    "caption": "天ぷらは蒸気で衣が湿りやすいため、網で油を切り、食べる分ずつ盛ります。"
  }
],name:'天ぷら',image:'/images/kisu-tempura.png',summary:'ふわっと軽い白身を楽しむ、シロギス料理の王道。',ingredients:['シロギス','天ぷら粉または薄力粉','冷水','揚げ油','塩または天つゆ'],steps:['背開きにして中骨を外し、水気を拭く','冷たい衣を薄くまとわせる','170〜180℃の油で衣が軽く色づくまで揚げる','油を切り、熱いうちに塩や天つゆで食べる'],tips:['衣を混ぜすぎない','小型で身が薄いので揚げすぎない']},
      {preparation:'raw',slug:'sashimi',name:'刺身',image:'/images/kisu-sashimi.png',summary:'良型の新鮮なシロギスならではの、繊細な甘みと透明感を楽しむ。',ingredients:['刺身用シロギス','大葉','わさび','醤油'],steps:['三枚おろしにして腹骨と小骨を取る','皮を引き、水分をしっかり拭く','小さな身に合わせて薄めに切り付ける','冷やした器に盛り薬味を添える'],tips:['身が小さいので厚く大ぶりに切らない','鮮度管理と生食上の安全対策を徹底する']},
