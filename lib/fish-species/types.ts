...
export type Recipe={nextLinks?:import('../content-navigation').ContentLink[];stepImages?:{step:number;src:string;alt:string;caption:string}[];detail?:RecipeDetail;preparation?:'raw'|'cooked';slug:string;name:string;image?:string;summary:string;ingredients:string[];steps:string[];tips:string[]};
