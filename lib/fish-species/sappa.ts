    ...
    "recipes": [
      {
        ...
        "stepImages": [
          {
            ...
            "caption": "生食用に処理された身を使う。腹骨をすき取り、身の中央に残る小骨も確かめる。"
          },
          {
            "step": 2,
            "src": "/images/cooking/steps/sappa-sunomono-2.svg",
            "alt": "サッパのままかりの酢漬け：冷蔵で塩をなじませる",
            "caption": "時間を置く間も冷蔵する。出た水分を拭いてから合わせ酢へ移す。"
          },
          {
            "step": 3,
            "src": "/images/cooking/steps/sappa-sunomono-3.svg",
            "alt": "サッパのままかりの酢漬け：浅い容器で酢に浸す",
            "caption": "身を厚く重ねず、合わせ酢が全体に行き渡るようにする。塩や酢は寄生虫対策にはならない。"
          },
          {
            "step": 4,
            "src": "/images/cooking/steps/sappa-sunomono-4.svg",
            "alt": "サッパのままかりの酢漬け：銀皮を上にして盛る",
            "caption": "食べる直前に汁気を切り、身を崩さないように取り出す。"
          }
        ],
        "detail": {
          "intro": "サッパは岡山で「ままかり」と呼ばれる小魚。酢漬けには開いた魚を使う作り方もあるが、ここでは食べやすさを優先して三枚おろしにする。焼いてから酢に漬ける料理とは下処理が異なる。",
          "checkpoints": [
            {
              "title": "小骨を先に確認する",
              "body": "腹骨をすき取り、指の腹で身の中央をなぞって残った骨を探す。銀皮を残して盛ると見た目も整う。骨が気になる場合は無理に丸ごと食べず、取り除く。"
            },
            {
              "title": "塩をした後の水分を持ち込まない",
              "body": "塩を振って出た水分はペーパーで拭く。水分が多いまま漬けると合わせ酢が薄まりやすいため、身を重ねすぎず浅い容器で浸す。"
            },
            {
              "title": "酢漬けと焼き酢漬けを選び分ける",
              "body": "このページは生食用の身を使う作り方。生食向けに処理されたものを用意できない場合は、中心まで加熱してから甘酢を合わせる焼き酢漬けに切り替える。"
            }
          ],
          "troubleshooting": [
            {
              "problem": "身が崩れて盛りにくい",
              "solution": "漬けた身を箸で何度もつかまず、平たい道具で下から支える。盛り付ける直前まで冷蔵し、汁気を切って取り出す。"
            },
            {
              "problem": "酢が強すぎる",
              "solution": "合わせ酢は魚を入れる前に味を調整する。取り出した魚に、薄切りしょうがやきゅうりを少量添えると食べやすくなる。"
            },
            {
              "problem": "骨がまだ硬い",
              "solution": "酢に漬ければすべての骨が食べられるとは限らない。漬け時間を延ばすことで解決しようとせず、骨を取り除く。"
            }
          ],
          "sources": [
            {
        ...
        "name": "ままかりの酢漬け",
        "preparation": "raw",
        "summary": "サッパ（ままかり）を三枚におろし、塩で出た水分を拭いて酢漬けにする。小骨の確認、酢の味の整え方、焼き酢漬けとの違いまで整理。生食用に処理・管理された身を使う。",
        "ingredients": [
          "生食用サッパの柵 200g",
          "塩 小さじ1/2",
          "酢100ml・砂糖 大さじ1",
        ...
        "nextLinks": [
          {
            "label": "加熱するなら南蛮漬け",
            "href": "/cooking/sappa/nanban",
            "reason": "生食用の身を用意できないときは、揚げて甘酢へ漬ける。"
          },
          {
            "label": "サッパとコノシロの見分け方",
            "href": "/fish/sappa",
            "reason": "持ち帰った小魚の特徴を確かめ、料理に使う魚を確認する。"
          }
        ]
      },
      {
      ...
      {
"detail":{"intro":"小骨を処理した身を揚げ、野菜入りの漬け汁へ。酢で骨や寄生虫の問題が解決するわけではないため、骨取りと加熱を別々に行う。","checkpoints":[{"title":"骨を確認してから粉を付ける","body":"腹骨・小骨を確かめ、水気を拭く。揚げればすべての骨が柔らかくなるとは考えず、食べる人に合わせて取り除く。"},{"title":"漬け汁を先に用意","body":"野菜を薄く切り、調味料を合わせる。揚がった魚を待たせず漬けられるよう、容器も準備する。"},{"title":"油を切ってから漬ける","body":"魚の中心まで加熱し、油を切って漬け汁へ。粗熱が取れたら冷蔵し、常温に置き続けない。"}],"troubleshooting":[{"problem":"衣がべたつく","solution":"粉を厚く付けず、油を切ってから漬ける。衣を軽く残したい場合は食べる直前に短く合わせる。"},{"problem":"味が薄い","solution":"魚や野菜の水気を確認。調味料を増やす前に、漬け汁が水分で薄まっていないか見る。"},{"problem":"骨が硬い","solution":"次は揚げる前に骨を取り除く。酢漬けや長い揚げ時間だけに頼らない。"}],"sources":[]},
        "slug": "nanban",
        "name": "南蛮漬け",
        "preparation": "cooked",
