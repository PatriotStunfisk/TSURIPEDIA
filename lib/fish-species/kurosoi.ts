...
export default defineFishSpecies({
  ...
  "cooking": {
    ...
    "recipes": [...(["nitsuke","karaage","sakamushi","ushiojiru"].map(slug=>({...({...({...cookedRecipe(fish,slug,"骨を除いた皮付きの身","頭やひれの棘を避けて下処理し、骨のない身で食べやすく仕上げます。"),...(slug==="sakamushi"?{stepImages:[{"step": 1, "src": "/images/cooking/steps/kurosoi-sakamushi-1.svg", "alt": "クロソイの酒蒸し：皮付きの身の骨を確認", "caption": "三枚おろしにした身も小骨が残ることがあります。指で確かめて取り除きます。"}, {"step": 2, "src": "/images/cooking/steps/kurosoi-sakamushi-2.svg", "alt": "クロソイの酒蒸し：塩の後に水気を拭く", "caption": "蒸し汁を薄めすぎないよう、塩をした後の水分を拭いてから皿へ移します。"}, {"step": 3, "src": "/images/cooking/steps/kurosoi-sakamushi-3.svg", "alt": "クロソイの酒蒸し：昆布と野菜の上へ", "caption": "身を重ねず並べると加熱をそろえやすくなります。酒と水があふれない深さの耐熱皿を使います。"}, {"step": 4, "src": "/images/cooking/steps/kurosoi-sakamushi-4.svg", "alt": "クロソイの酒蒸し：厚い部分まで蒸す", "caption": "15分は目安です。身の厚さや量で変わるため、中心の加熱を確認し、最後の工程で蒸し汁ごと盛ります。"}]}:{})}),...(slug==="sakamushi"?{stepImages:[{"step": 1, "src": "/images/cooking/steps/kurosoi-sakamushi-1.svg", "alt": "クロソイの酒蒸し：皮付きの身の骨を確認", "caption": "三枚おろしにした身も小骨が残ることがあります。指で確かめて取り除きます。"}, {"step": 2, "src": "/images/cooking/steps/kurosoi-sakamushi-2.svg", "alt": "クロソイの酒蒸し：塩の後に水気を拭く", "caption": "蒸し汁を薄めすぎないよう、塩をした後の水分を拭いてから皿へ移します。"}, {"step": 3, "src": "/images/cooking/steps/kurosoi-sakamushi-3.svg", "alt": "クロソイの酒蒸し：昆布と野菜の上へ", "caption": "身を重ねず並べると加熱をそろえやすくなります。酒と水があふれない深さの耐熱皿を使います。"}, {"step": 4, "src": "/images/cooking/steps/kurosoi-sakamushi-4.svg", "alt": "クロソイの酒蒸し：厚い部分まで蒸す", "caption": "15分は目安です。身の厚さや量で変わるため、中心の加熱を確認し、最後の工程で蒸し汁ごと盛ります。"}]}:{})}),...(slug==="sakamushi"?{stepImages:[{"step": 1, "src": "/images/cooking/steps/kurosoi-sakamushi-1.svg", "alt": "クロソイの酒蒸し：皮付きの身の骨を確認", "caption": "三枚おろしにした身も小骨が残ることがあります。指で確かめて取り除きます。"}, {"step": 2, "src": "/images/cooking/steps/kurosoi-sakamushi-2.svg", "alt": "クロソイの酒蒸し：塩の後に水気を拭く", "caption": "蒸し汁を薄めすぎないよう、塩をした後の水分を拭いてから皿へ移します。"}, {"step": 3, "src": "/images/cooking/steps/kurosoi-sakamushi-3.svg", "alt": "クロソイの酒蒸し：昆布と野菜の上へ", "caption": "身を重ねず並べると加熱をそろえやすくなります。酒と水があふれない深さの耐熱皿を使います。"}, {"step": 4, "src": "/images/cooking/steps/kurosoi-sakamushi-4.svg", "alt": "クロソイの酒蒸し：厚い部分まで蒸す", "caption": "15分は目安です。身の厚さや量で変わるため、中心の加熱を確認し、最後の工程で蒸し汁ごと盛ります。"}]}:{})}))),{
  "slug": "sashimi",
