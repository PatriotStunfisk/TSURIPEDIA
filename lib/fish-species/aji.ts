...
export default defineFishSpecies({
  fieldNotes: [{"heading": "一匹釣れたら深さを覚える", "body": "マアジは群れで泳ぐため、一匹釣れた棚を再現することが次の手掛かりになります。サビキなら掛かった針の上下、アジングなら沈めた時間を記録。同じ場所で釣れなくなったときも、まず直前の棚の上下を探ります。"}, {"heading": "表層の小魚だけで判断しない", "body": "水面の魚がすべてアジとは限りません。釣れた魚のゼイゴなどで種類を確認し、見えている群れとアタリが出る層を分けて考えます。小型ばかりなら針を大きくするだけでなく、狙う棚や時間も見直しましょう。"}],
  ecologyVisual: {
  "title": "群れで泳ぐ、岸近くの回遊魚",
