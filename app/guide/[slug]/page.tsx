...
export default async function GuideArticlePage({params}:{params:Promise<{slug:string}>}){
 ...
 return <div className="section pageTop">
  ...
  <section style={{margin:'24px 0',padding:'24px',borderRadius:20,background:'#0e2f43',color:'#fff'}}><span style={{fontSize:12,fontWeight:900,letterSpacing:1.4,opacity:.72}}>まず結論</span><p style={{fontSize:21,lineHeight:1.8,fontWeight:800,margin:'8px 0 0'}}>{a.answer}</p></section>
  ...
  <p style={{fontSize:12,lineHeight:1.7,opacity:.62,marginTop:22}}>※釣具の号数・重量や仕掛けは、釣り場・潮・対象サイズ・船宿ルールで変わります。現地や船宿の指定がある場合は、その指定を優先してください。</p>
 </div>
}
