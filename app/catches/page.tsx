...
export default function Page(){return <div className="section pageTop"><h1>自分の釣果を残そう</h1><CloudCatchJournal options={catchOptions()}/><RealCatchJournal options={catchOptions()}/><Link href="/quest/profile">QUESTのマイ記録へ →</Link></div>}
