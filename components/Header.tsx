...
export default function Header({locale='ja'}:{locale?:'ja'|'en'}){
 ...
 const links=en?[['/en','Home'],['/en/fish','Fish'],['/en/methods','Methods'],['/en/guide','Guides'],['/en/spots','Fishing map'],['/en/cooking','Cooking'],['/weather','Weather']]:[['/','ホーム'],['/fish','魚図鑑'],['/methods','釣り方'],['/guide','釣りガイド'],['/spots','釣り場マップ'],['/gear','釣具'],['/cooking','料理'],['/quest','QUEST'],['/weather','天気']];
