...
export default function MadaiMedia(){
 ...
 return <div style={{position:'absolute',inset:0,overflow:'hidden'}}>
  ...
  <div style={{position:'absolute',inset:0,padding:'54px 22px 48px',display:'flex',alignItems:'center',justifyContent:'center'}}>
   {mode==='2d'?<img src={establishedFishImages.madai} alt="マダイの図鑑画像" style={{display:'block',width:'100%',height:'100%',objectFit:'contain',filter:'drop-shadow(0 14px 18px rgba(0,20,32,.28))'}}/>:<MadaiViewer/>}
  </div>
