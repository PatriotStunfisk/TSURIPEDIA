...
export default function SpotMapPreview({entry,shop,onClose,onDetails,fishNames={}}:{fishNames?:Record<string,string>;methodNames?:Record<string,string>;entry?:FishingMapEntry;shop?:TackleShop;onClose:()=>void;onDetails:()=>void}){
