...
export type CatchSession={user:{id:string;email?:string;displayName?:string;avatarUrl?:string}|null;moderator?:boolean;available?:boolean;loading:boolean;error?:string};
