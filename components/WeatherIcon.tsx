...
function Symbol({kind}:{kind:WeatherKind}) {
  return <svg viewBox="0 0 32 32" width="26" height="26" aria-hidden="true">
    {kind === 'sun' ? <g stroke="#1687e8" strokeWidth="2" strokeLinecap="round"><circle cx="16" cy="16" r="6" fill="#bce8ff"/>{[0,45,90,135,180,225,270,315].map(angle=><path key={angle} d="M16 3v3" transform={`rotate(${angle} 16 16)`}/>)}</g> : <>
      ...
      {kind==='storm'&&<path d="m17 18-5 9h5l-2 5 8-10h-6l3-4Z" fill="#1687e8"/>}
    </>}
  </svg>;
}
