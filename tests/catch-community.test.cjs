...
test('authenticated API flow enforces owner, moderation, reports, quotas and photo cleanup',async()=>{
 ...
 const req=(method,body,path='/api/catches',origin='https://uolink.vercel.app')=>new Request('https://uolink.vercel.app'+path,{method,headers:{origin,'Content-Type':'application/json'},body:JSON.stringify(body)});
 try{
